                    ...
                    <div class="row mb-1">
                        ...
                        <table border="1" class="table table-bordered">
                          ...
                          <?php
                            ...
                            $query_mysql = $conn->query("SELECT * FROM pengukuran") or die(print_r($conn->errorInfo(), true));
                            $nomor = 1;
                            while($data = $query_mysql->fetch(PDO::FETCH_ASSOC)){
                                $id = $data['id'];
                                $nik = $data['nik'];
                                $query_mysql_2 = $conn->query("SELECT nama FROM anak WHERE nik = '$nik'") or die(print_r($conn->errorInfo(), true));
                                $data_balita = $query_mysql_2->fetch(PDO::FETCH_ASSOC);
                          ?>
                          <tr>
			                <td><?php echo $nomor++; ?></td>
                            <td><?php echo $data_balita['nama']; ?></td>
                            ...
                            <a class="edit" href="edit_pengukuran.php?id=<?php echo $data['id']; ?>">
                            ...
                            <a class="hapus" href="delete_pengukuran.php?id=<?php echo $data['id']; ?>">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-3 align-self-end">
                                    <a href="tambah_data_pengukuran.php">
