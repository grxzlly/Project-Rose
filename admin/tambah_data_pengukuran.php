...
<head> 
  ...
  <title>Posyandu Mawar | Tambah Pengukuran</title><!--begin::Primary Meta Tags-->
            ...
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    ...
                    <table border="0" class="table table-hover table-dark table-striped">
                        <form action="tambah_data_pengukuran_aksi.php" method="POST">
                            <tr>
                               <td>NIK</td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tanggal_pengukuran"></td>
                            </tr>
                            <tr>
                                <td>Berat Badan</td>
                                <td><input type="float" name="berat_badan"></td>
                            </tr>
                            <tr>
                                <td>Tinggi Badan</td>
                                <td><input type="float" name="tinggi_badan"></td>
                            </tr>
                            <tr>
                                <td>BBU</td>
                                <td><input type="text" name="bbu"></td>
                            </tr>
                            <tr>
                                <td>TBU</td>
                                <td><input type="text" name="tbu"></td>
                            </tr>
                            <tr>
                                <td>BBTB</td>
                                <td><input type="text" name="bbtb"></td>
                            </tr>
